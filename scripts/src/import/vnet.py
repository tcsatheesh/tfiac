...
class ImportState:
    ...
    def _import_vnet(
        ...
        _vnet_variables = self._import_variables(
            file_path=_args.variables,
        )
        _remote_vnet_variables = self._import_variables(
            file_path=_args.remote_vnet_variables,
        )
        _firewall_variables = self._import_variables(
        ...
        _logger.info(f"Importing VNet resource group {_vnet_resource_group_name}...")
