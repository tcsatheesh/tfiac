# Reference variables + the 6 mock_provider blocks every test in this directory
# expects. terraform test does NOT merge variables/provider blocks across .tftest.hcl
# files - each test file MUST declare its own copies.
