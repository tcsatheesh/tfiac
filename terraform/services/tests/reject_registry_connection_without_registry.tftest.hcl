# FR-063 / C-079 — enabling the Foundry project ContainerRegistry connection
# without a 'container_registry' selection hard-fails at plan time via
...
run "rejects_registry_connection_without_registry" {
  command = plan
  expect_failures = [
    check.aifoundry_container_registry_connection_prereqs,
  ]
