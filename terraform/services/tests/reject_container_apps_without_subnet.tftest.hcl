# C-021 / FR-030 — selecting a `container_app_environment` without
# enable_container_apps = true hard-fails at plan time via
...
run "rejects_container_apps_without_subnet" {
  command = plan
  expect_failures = [
    check.container_app_env_requires_subnet,
  ]
