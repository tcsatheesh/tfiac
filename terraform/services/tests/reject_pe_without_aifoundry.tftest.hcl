# C-018 / FR-027 — enabling the Foundry private endpoint without an `aifoundry`
# selection hard-fails at plan time via check.aifoundry_pe_requires_account.
...
run "rejects_pe_without_aifoundry" {
  command = plan
  expect_failures = [
