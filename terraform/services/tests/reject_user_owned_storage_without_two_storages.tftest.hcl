# FR-044 / C-060 — enabling userOwnedStorage without TWO storage selections (and
# distinct purposes) hard-fails at plan time via
...
run "rejects_user_owned_storage_without_two_storages" {
  command = plan
  expect_failures = [
    check.aifoundry_user_owned_storage_prereqs,
  ]
